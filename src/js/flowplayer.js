...
var createVideoTag = function(video, autoplay, preload, useCache) {
  ...
  el.autoplay = autoplay ? 'autoplay' : true;
  el.preload = preload;
   ...
   return self = {
      ...
      load: function(video) {
         ...
         if (conf.splash && !api) {
           ...
           api = createVideoTag(video, !!conf.clip.preload || 'metadata', false);
           common.prepend(container, api);
           created = true;
         } else {
